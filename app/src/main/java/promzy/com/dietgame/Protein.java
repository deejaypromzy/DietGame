...
public class Protein extends Activity {
   ...
   int SCORE=0;
    ...
    public void openDialog(){
        if(SCORE<40) {
            ...
            Intent myInt = new Intent(Protein.this,game_over.class);
    ...
    private void gameSuccess() {
        if(SCORE>=40 && !Objects.equals(timerTextView.getText().toString(), "Time Up !!")){
            ...
            Intent myInt = new Intent(Protein.this,game_success.class);
            startActivity(myInt);
            bg_Sound.stop();
            applause.start();
            finish();
